...
class Journey(db.Model):
    ...
    free_capacity_length = db.Column(db.Float)
    free_capacity_weight = db.Column(db.Float)
    free_capacity_width = db.Column(db.Float)
    free_capacity_height = db.Column(db.Float)
    used_capacity_length = db.Column(db.Float)
    used_capacity_weight = db.Column(db.Float)
    used_capacity_width = db.Column(db.Float)
    used_capacity_height = db.Column(db.Float)
